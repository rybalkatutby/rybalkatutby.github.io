...
<style type="text/css">
	#mc_embed_signup{background:#99ccff; clear:left; font:14px Helvetica,Arial,sans-serif;  width:480px;}
...
<div class="mc-field-group">
    ...
    <div class="clear"><input type="submit" value="Подписаться" name="subscribe" id="mc-embedded-subscribe" class="button" background="#aaaaaa" color="#aaaaaa#  ></div>
    </div>
</form>
</div>
